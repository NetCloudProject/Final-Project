...
def unpack(object_list):
    rst = []
    for ob in object_list:
        curr = {}
        curr["id"] = ob.id 
        curr["start"] = ob.travel_start_time 
        curr["end"] = ob.travel_end_time
        curr["location"] = ob.travel_location
...
def update(plan_id):
    ...
    return jsonify(url_for("main_page"))
